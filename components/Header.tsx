  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-10">
      ...
      <div className="flex items-center space-x-4">
        <button className="p-2 text-gray-500 hover:bg-gray-100 rounded-md border border-gray-200">
          <MessageSquare size={18} />
        </button>
        <button className="p-2 text-gray-500 hover:bg-gray-100 rounded-md border border-gray-200 relative">
          <Bell size={18} />
        ...
        >
          <img 
            ...
            alt={user?.name} 
            className="w-9 h-9 rounded-full object-cover mr-3 border border-gray-100"
          />
          <div className="mr-2">
